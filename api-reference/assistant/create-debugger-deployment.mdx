---
title: "Create Debugger Deployment"
description: "Create an assistant debugger deployment from the Rapida SDK."
---
...
| `1004007` | `idealTimeout` must be between `5` and `120` seconds. |
