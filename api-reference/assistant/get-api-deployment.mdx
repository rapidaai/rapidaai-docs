---
title: "Get API Deployment"
description: "Get an assistant API deployment from the Rapida SDK."
---
...
func main() {
	...
	if err != nil {
		fmt.Printf("error while getting API deployment: %+v\n", err)
		return
	}
	fmt.Printf("get API deployment response: %+v\n", response)
}
```
...
| Code | Meaning |
| --- | --- |
| `1011001` | Unauthenticated request. |
| `1011002` | Missing authentication scope. |
| `1011003` | Invalid `assistantId`. |
| `1011004` | Unable to get assistant API deployment. |
