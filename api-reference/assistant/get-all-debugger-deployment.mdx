---
title: "Get All Debugger Deployments"
description: "Get assistant debugger deployments from the Rapida SDK."
---

Gets paginated debugger deployments for an assistant. Use user-scoped authentication because the operation requires organization and project context.
