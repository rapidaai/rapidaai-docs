...
| Field | Value |
|-------|-------|
| **Answer URL** | `https://websocket-01.in.rapida.ai/v1/talk/vonage/call/{your-assistant-id}` |
| **Event URL** | `https://websocket-01.in.rapida.ai/v1/talk/vonage/ctx/{contextId}/event` |
| **HTTP Method** | `POST` |
