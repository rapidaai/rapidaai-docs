...
| **URL** | `https://api.rapida.ai/v1/talk/twilio/call/{your-assistant-id}` |
| **HTTP Method** | `POST` |
...
| Field | Value |
|-------|-------|
| **Status Callback URL** | `https://api.rapida.ai/v1/talk/twilio/ctx/{contextId}/event` |
...
<AccordionGroup>
  ...
  <Accordion title="Status callbacks not received">
    ...
    - Verify the URL format: `https://api.rapida.ai/v1/talk/twilio/ctx/{contextId}/event`
