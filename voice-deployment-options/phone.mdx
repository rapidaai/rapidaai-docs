...
<Tip>
Use the [Voice Pipeline Overview](/assistants/voice-pipeline) to choose STT, TTS, VAD, noise cancellation, EOS, pronunciation, and latency settings before going live.
</Tip>
