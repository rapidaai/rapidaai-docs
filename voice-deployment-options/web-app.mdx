...
<Tip>
Use the [Voice Pipeline Overview](/assistants/voice-pipeline) when enabling microphone input, spoken responses, or real-time voice behavior in your app.
</Tip>
...
- [Voice Pipeline Overview](/assistants/voice-pipeline) — Choose and tune STT, TTS, VAD, EOS, and pronunciation settings
