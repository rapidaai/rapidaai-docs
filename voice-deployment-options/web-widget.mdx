...
<Steps>
  <Step title="Experience">
    ...
    **Advanced settings** (expand to configure):
    ...
    - **Unclear Speech Message** — Message shown/spoken when the user interrupted but did not continue, or speech was not recognized confidently (default: `I didn't catch that. Could you repeat that?`)
    - **Idle Silence Timeout** — Duration of silence before Rapida prompts the user (5-60 seconds, default: 30s)
