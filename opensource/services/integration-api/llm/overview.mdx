...
<CardGroup cols={3}>
  ...
  <Card title="Anthropic" icon="robot" href="/opensource/services/integration-api/llm/anthropic">
    Claude Opus, Sonnet, Haiku
  </Card>
  <Card title="Gemini" icon="google" href="/opensource/services/integration-api/llm/gemini">
    Gemini 2.0 Flash, 1.5 Pro
  </Card>
  <Card title="Azure OpenAI" icon="microsoft" href="/opensource/services/integration-api/llm/azure">
