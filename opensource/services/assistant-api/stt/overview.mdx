...
| **Smallest AI** | `smallest` | ✅ | Pulse, 64ms TTFT, diarization, PII/PCI redaction |
...
<CardGroup cols={3}>
  ...
  <Card title="Google Cloud" icon="globe" href="/opensource/services/assistant-api/stt/google">
    100+ languages, Neural Speech
  </Card>
  <Card title="Azure" icon="cloud" href="/opensource/services/assistant-api/stt/azure">
    Neural Speech, 140+ languages
  </Card>
  <Card title="AssemblyAI" icon="activity" href="/opensource/services/assistant-api/stt/assemblyai">
    Speaker diarization, real-time
  </Card>
  <Card title="Rev.ai" icon="audio-waveform" href="/opensource/services/assistant-api/stt/revai">
    Real-time streaming
  </Card>
  <Card title="Sarvam AI" icon="languages" href="/opensource/services/assistant-api/stt/sarvamai">
    Indian languages
  </Card>
  <Card title="Smallest AI" icon="zap" href="/opensource/services/assistant-api/stt/smallest">
    Pulse, 64ms TTFT, diarization, redaction
  </Card>
  <Card title="Custom STT" icon="code" href="/opensource/services/assistant-api/stt/custom">
    Configure WebSocket or HTTP STT with DSL rules
  </Card>
</CardGroup>
