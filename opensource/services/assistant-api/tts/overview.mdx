...
| **Smallest AI** | `smallest` | ✅ | Lightning v3.1/Pro, ~100ms to first chunk |
...
<CardGroup cols={3}>
  ...
  <Card title="Smallest AI" icon="zap" href="/opensource/services/assistant-api/tts/smallest">
    Lightning v3.1/Pro, ~100ms to first chunk
  </Card>
