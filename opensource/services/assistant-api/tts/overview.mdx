...
<CardGroup cols={3}>
  <Card title="Deepgram Aura" icon="waveform" href="/opensource/services/assistant-api/tts/deepgram">
  ...
  <Card title="Google Cloud" icon="google" href="/opensource/services/assistant-api/tts/google">
    WaveNet / Neural2
  </Card>
  <Card title="Azure" icon="microsoft" href="/opensource/services/assistant-api/tts/azure">
    Neural voices, 140+ languages
  </Card>
  <Card title="Sarvam AI" icon="language" href="/opensource/services/assistant-api/tts/sarvamai">
    Indian languages
  </Card>
