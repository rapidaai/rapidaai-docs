...
Use one of these route users from any SIP phone, softphone, or PBX:
...
| `did` | Phone value configured on the assistant's active SIP phone deployment |
...
<CardGroup cols={2}>
  <Card title="ngrok — Local Testing" icon="route" href="/opensource/services/assistant-api/ngrok">
