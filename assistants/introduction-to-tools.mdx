---
title: "Tools"
description: "Enhance your assistant's capabilities with built-in and custom tools"
sidebarTitle: "Tools"
---
...
<Info>
  Tools are configured as part of your assistant's model configuration. You can
  find the complete API reference [here](/api-reference/tools/create-tool).
</Info>

## Available Tools

<Cards>
  <Card title="Default Tools" icon="settings" href="/tools/default-tools">
  ...
  <Card title="Make & GHL Tools" icon="puzzle" href="/tools/GHL">
...
<Card title="Function Calling" icon="terminal">
