...
<CardGroup cols={2}>
  ...
  <Card title="Tools" icon="zap">
    Let the LLM call tools mid-conversation: knowledge, APIs, endpoint prompts, transfer, hold, and end session.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Tools" icon="zap" href="/assistants/introduction-to-tools">
    Add knowledge retrieval, API calls, endpoint invocations, call transfer, hold, and end-of-conversation tools.
  </Card>
