...
| VAD threshold | `0.6` | 0.5–1.0 | Speech detection sensitivity. Lower = more sensitive (may catch noise). Higher = stricter (may miss quiet speech) |
| EOS timeout | `700 ms` | 500–4000 ms | Silence duration before the assistant treats a pause as end-of-turn. Increase for conversational pauses; decrease for snappy IVR-style responses |
